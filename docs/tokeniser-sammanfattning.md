...
| Q14 | **Prognos för 5 h:** takten räknas på ökningen under de senaste 30 min. Den kräver minst 3 mätningar över minst 10 min och döljs när datan är "Äldre". Texten blir "Når gränsen cirka kl. 15:40" eller "Räcker till återställningen kl. 17:00". **Veckan** räknas likadant på de senaste 24 h. Alltid märkt "uppskattning". |
